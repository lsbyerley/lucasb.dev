<template>
  <nav class="nav relative z-20">
    <div class="flex items-center justify-between px-6 py-2 mx-auto">
      <a class="text-2xl font-semibold text-gray-100 lg:text-4xl" href="/"
        >lucasb.dev</a
      >
      <div class="block">
        <button
          ...
          class="block text-gray-100 focus:outline-none hover:text-gray-400 focus:text-gray-100"
          aria-label="OpenMenu"
        >
        ...
        <button
          ...
          class="text-gray-100 focus:outline-none hover:text-gray-400 focus:text-gray-100"
    ...
    <div
      class="navbar fixed h-screen w-full bg-blue-900"
      :class="{ 'navbar-open': isOpen }"
    >
      <div class="pt-16">
        <router-link
          class="block py-4 text-center text-gray-200 hover:text-gray-400"
          to="/"
          >Home</router-link
        >
        <router-link
          class="block py-4 text-center text-gray-200 hover:text-gray-400"
          to="swanson"
          >Random Swanson</router-link
        >
        <router-link
          class="block py-4 text-center text-gray-200 hover:text-gray-400"
          to="teasers"
          >NFL Teasers</router-link
        >
        <a
          class="block py-4 text-center text-gray-200 hover:text-gray-400"
    ...
    >
      <div class="absolute top-0 left-0 w-screen h-screen bg-blue-900" v-if="isOpen">
        ...
        <div class="pt-16">
          ...
          <a class="block py-4 text-center text-gray-500 hover:text-gray-400" href="https://steelehoops.com/" target="_blank" rel="noopener">SteeleHoops</a>
        </div>
      </div>
    </transition>-->
  </nav>
...
<style lang="scss">
.navbar {
  // clip-path: circle(5% at -5% 5%);
  clip-path: circle(2% at 98% -5%);
